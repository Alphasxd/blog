...
![image-20231014204944391](https://imag3s.pages.dev/file/22d2e972c15e2ead2a53d.png)

## 隐私计算的潜在需求

![image-20231014205136866](https://imag3s.pages.dev/file/a6dcf5a6e6b0401413cac.png)
...
![image-20231014205507032](https://imag3s.pages.dev/file/c288f0d56b98a718c2894.png)
...
![image-20231014205915467](https://imag3s.pages.dev/file/645d7bccae36747fd892e.png)
...
![image-20231014211724804](https://imag3s.pages.dev/file/456c1ee2c9d12f7e81261.png)

## 安全多方计算

姚氏百万富翁问题

![image-20231014212103746](https://imag3s.pages.dev/file/17db44ea4aaffd1922eaf.png)
...
![image-20231014212527955](https://imag3s.pages.dev/file/871478220f2bbcf7b2f04.png)
...
![image-20231015105305736](https://imag3s.pages.dev/file/53c0b77047742b3c0426b.png)
...
![image-20231015111633947](https://imag3s.pages.dev/file/d89ab56019f326aadd54b.png)

**特定问题的安全多方计算：**

为了计算某个具体功能，目前情况下有一些实际应用场景

![image-20231015111822183](https://imag3s.pages.dev/file/b01ce5052764dc6a4bf3b.png)
...
![image-20231015112006304](https://imag3s.pages.dev/file/f522c7e4e14dff50a49dd.png)

核心思想是利用设计的加密函数，能够保证先对这个数据，进行运算然后再加密，跟先对这个数据加密之后再运算是等价的

![image-20231015112211093](https://imag3s.pages.dev/file/a02eca17705a561c639ab.png)
...
![image-20231015112650869](https://imag3s.pages.dev/file/53f9b9f63511a498e7a5b.png)
...
![image-20231015113411063](https://imag3s.pages.dev/file/1554379a987bcd6e5233a.png)

## 零知识证明 

![image-20231015114029504](https://imag3s.pages.dev/file/c8eb023f133685d291277.png)
...
![image-20231015114153185](https://imag3s.pages.dev/file/9d7300ecdc7196c2f8147.png)

zk-SNARK: 简明非交互式零知识证明

![image-20231015122108715](https://imag3s.pages.dev/file/28a9c72ac94898103d390.png)
...
![image-20231015123107688](https://imag3s.pages.dev/file/89a5cebf1e7f765d70cd6.png)
...
![image-20231015123125099](https://imag3s.pages.dev/file/ddf114cc91f2feffc4a8d.png)
...
![image-20231015124521710](https://imag3s.pages.dev/file/135e893b810a6b2e45c59.png)

最早跟隐私计算没有太直接的关系

最早计算机的单机安全性就用到了，比如手机上的生物解锁，指纹或者面容，存在一个安全领域是比较好的，跟手机上的其他应用隔离开

![image-20231015125002010](https://imag3s.pages.dev/file/a0c308d6a2d41340b3d1d.png)

## 隐私计算与区块链

基于区块链和TEE的数据分析服务

![image-20231015125242748](https://imag3s.pages.dev/file/6dcff9614327711ec31ed.png)

基于区块链和MPC实现行业热点整合

![image-20231015125219269](https://imag3s.pages.dev/file/fd0ddbb7d7f8c959ac3b4.png)
...
![image-20231015125352858](https://imag3s.pages.dev/file/e1cb212b45958a3232d5f.png)
...
![image-20231015125121186](https://imag3s.pages.dev/file/b5a68db2218bc7efe1ca1.png)
